...
try:
    import wandb
    wandb.login(key="43481bc506dc08f34bf1a0f78d768118ffea74a1")
    wandb.init(project="FedNH")
...
def run(args):
    ...
    with open(args.yamlfile, "r") as stream:
        config = yaml.load(stream, Loader=yaml.Loader) #return a dict of config
...
if __name__ == "__main__":
    ...
    parser.add_argument('--global_seed', default=2025, type=int, help='Global random seed.')
